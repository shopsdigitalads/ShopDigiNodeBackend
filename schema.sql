...
CREATE DATABASE IF NOT EXISTS shopdigitalads;
USE shopdigitalads;
...
-- 11. AdvertisementLocation Table
...
-- 15. AdvertisementBill Table (not used logically)
